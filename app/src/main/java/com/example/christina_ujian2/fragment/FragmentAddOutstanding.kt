...
class FragmentAddOutstanding : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_add_outstanding, container, false)
    }
    ...
    fun sendData(view: View) {
        ...
        // Call the addData function and enqueue the request
        apiService.addData(namaRequestBody, alamatRequestBody, outstandingRequestBody)
            .enqueue(object : Callback<ResponseSuccess> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        Log.i("Hasil add", responseData.toString())
                        exitFragment(view)
                    } else {
                        // Handle API error here
                        Log.e("Hasil API add", "Gagal")
                    }
                }
